...
// echo'<pre>';print_r($request->all());exit;
        ...
        if ($blog_id) {
            ...
            $blog_data = [
                'en' => [
                    'blog_title' => $request->input('en_blog_title'),
                    'blog_slug' => $request->input('en_blog_slug'),
                    'description' => $request->input('en_description')
                ],
                'es' => [
                    'blog_title' => $request->input('es_blog_title'),
                    'blog_slug' => $request->input('es_blog_slug'),
