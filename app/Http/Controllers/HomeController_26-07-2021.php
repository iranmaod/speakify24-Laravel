...
class HomeController extends Controller
{
    ...
    public function processpayment($id, Request $request)
    {
        ...
        try {
            ...
            // echo'<pre>';print_r($agreement->getData());exit;
            $main = explode('-', $id);
            $data = array();
            ...
            $data['payment_id'] = '';//$agreement->getId();
            ...
            return redirect('/')->with('success', 'You have subscribed to monthly package successfully.');
        } catch (PayPal\Exception\PayPalConnectionException $ex) {
            echo '<pre>';
            print_r($ex);
            print_r($agreement->getData());
            exit;
        } catch (Exception $ex) {
            echo '<pre>';
            print_r($ex);
