...
@section('content')
   ...
   <h3 style="text-align: center;font-size:25px;">Hi {{$data->student->first_name}}</h3>
     <p style="text-align: center;font-size:16px;">It's almost time! Your lesson with {{$data->instructor->first_name}} starts in one hour! on<br>
      {{$date}}
      at {{$time}} CET.
       <br>
        Log-in and click on the blue camera icon next to your name. <br>
        Enjoy!
