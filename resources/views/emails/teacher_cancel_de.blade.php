...
@section('content')
     ...
     <p style="text-align: center;font-size:16px;"> {{$data->student->first_name}} hat gerade diese Unterrichtseinheit storniert.
      <br>
      {{$date}}
        um {{$time}} CET. <br>
      <br>
    ...
    <p style="text-align: center;font-size:16px;">
        ...
        <p style="text-align: center;font-size:12px;">Schreiben Sie Ihrem Schüler eine Nachricht <a href="https://speakify24.de/messages">https://speakify24.de/messages</a></p> <br>
