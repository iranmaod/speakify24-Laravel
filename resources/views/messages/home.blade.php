            ...
            <div class="row message_main_wrapper">
                <div class="col-md-4">
                    <div class="user-wrapper">
                        <div class="chatsearch">
                            <input id="messageSearch" type="text" name="" placeholder="{{ __('booking.searchbyname') }}" onkeyup="myFunction()" />
                        </div>
                ...
                <div class="col-md-8" >
                    ...
                    <div class="input-text">
                        <input type="text" name="message" placeholder="{{ __('booking.entermsg') }}..." class="submit">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.user').click(function () {
                ...
                receiver_email = $(this).attr('email');
                $.ajax({
                    type: "get",
