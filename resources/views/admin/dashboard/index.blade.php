    ...
    <div class="col-md-3">
          ...
          <div class="card card-block p-30 bg-blue-600">
            ...
            <div class="counter counter-md counter-inverse text-left">
              <div class="counter-number-group">
                ...
                <span class="counter-number-related text-capitalize">teachers</span>
              </div>
              <div class="counter-label text-capitalize">in total</div>
            </div>
          </div>
        ...
        <div class="col-md-3">
          ...
          <div class="card card-block p-30 bg-yellow-600">
            ...
            <div class="counter counter-md counter-inverse text-left">
              <div class="counter-number-group">
                <span class="counter-number">{{ $metrics['pending_teacher'] }}</span>
                <span class="counter-number-related text-capitalize">pending teachers</span>
              </div>
              <div class="counter-label text-capitalize">in total</div>
            </div>
          </div>
        ...
        <div class="panel-body">
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    ...
                    <td>{!! \App\Models\Course::find($course->id)->getInstructors() !!}</td>
