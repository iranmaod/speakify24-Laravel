...
<div class="page-content">
    ...
    <div class="panel">
        <div class="panel-body">
            <form method="POST" action="{{ route('admin.testimonial.update') }}" id="testimonialForm">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="instructor_id" name="instructor_id" id="instructor_id">
                            ...
                            @foreach($instructors as $instructor)
                                <option value="{{ $instructor->id }}" {{ $review->instructor_id == $instructor->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="user_id" id="user_id">
                            ...
                            @foreach($students as $student)
                                <option value="{{ $student->id }}" {{ $review->user_id == $student->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="rating">
                            <option value="">Select</option>
                            <option value="1" @if('1' == $review->rating){{ 'selected' }}@endif>1</option>
                            <option value="2" @if('2' == $review->rating){{ 'selected' }}@endif>2</option>
                            <option value="3" @if('3' == $review->rating){{ 'selected' }}@endif>3</option>
                            <option value="4" @if('4' == $review->rating){{ 'selected' }}@endif>4</option>
                            <option value="5" @if('5' == $review->rating){{ 'selected' }}@endif>5</option>
                        </select>
