...
<div class="page-content">
	...
	<div class="panel">
		...
		<div class="panel-body">
			...
			<input type="hidden" name="code" value="pageEmailCancel">
			<div class="row">
				<div class="col-6">
			...
			<div class="card-body" id="english-form">
				<div class="form-group">
					...
					<textarea name="content[en]">{{ isset($config['en']['cancellation']) ? $config['en']['cancellation'] : '' }}</textarea>
				</div>
			</div>
			...
			<div class="card-body d-none" id="german-form">
				<div class="form-group">
					...
					<textarea name="content[de]">{{ isset($config['de']['cancellation']) ? $config['de']['cancellation'] : '' }}</textarea>
				</div>
			</div>
