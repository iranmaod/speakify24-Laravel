...
<div class="page-content">
	...
	<div class="panel">
		<div class="panel-body">
			...
			{{ csrf_field() }}
			<input type="hidden" name="code" value="pageReset">
			<div class="row">
				<div class="col-6">
			...
			<div class="card-body" id="english-form">
				<div class="form-group">
					...
					<textarea name="content[en]">{{ isset($config['en']['reset']) ? $config['en']['reset'] : '' }}</textarea>
				</div>
			</div>
			...
			<div class="card-body d-none" id="german-form">
				<div class="form-group">
					...
					<textarea name="content[de]">{{ isset($config['de']['reset']) ? $config['de']['reset'] : '' }}</textarea>
				</div>
			</div>
