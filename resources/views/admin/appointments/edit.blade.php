...
<div class="page-content">
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.appointment.update') }}" id="appintmentForm">
                {{ csrf_field() }}
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="title" 
                            placeholder="appointment Title" value="{{ $appointment->title }}" />
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="instructor_id" id="instructor_id">
                            ...
                            @foreach($instructors as $instructor)
                                ...
                                @if($instructor->id == $appointment->instructor_id){{ 'selected' }}@endif>
                    ...
                    <!-- <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="course_id" id="course_id">
                            ...
                            @foreach($courses as $course)
                                ...
                                @if($course->id == $appointment->course_id){{ 'selected' }}@endif>
                                    {{ $course->course_title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <!-- <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="lecture_id" id="lecture_id">
                            ...
                            {{-- @foreach($lectures as $lecture)
                                <option value="{{ $lecture->lecture_quiz_id }}"
                                @if($lecture->lecture_quiz_id == $appointment->lecture_id){{ 'selected' }}@endif>
                                    {{ $lecture->title }}
                                </option>
                            @endforeach --}}
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="user_id">
                            ...
                            @foreach($students as $student)
                                ...
                                @if($instructor->id == $appointment->user_id){{ 'selected' }}@endif>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="datetime" class="form-control" name="startdate" 
                            placeholder="Appointment Start Time" value="{{ $appointment->startdate }}" />
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="datetime" class="form-control" name="enddate" 
                            placeholder="Appointment End Time" value="{{ $appointment->enddate }}" />
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="status">
                            <option value="">Select</option>
                            <option value="0" @if('0' == $appointment->status){{ 'selected' }}@endif>Pending</option>
                            <option value="1" @if('1' == $appointment->status){{ 'selected' }}@endif>Accepted</option>
                            <option value="2" @if('2' == $appointment->status){{ 'selected' }}@endif>Rejected</option>
                            <option value="3" @if('3' == $appointment->status){{ 'selected' }}@endif>Cancelled</option>
                            <option value="4" @if('4' == $appointment->status){{ 'selected' }}@endif>Completed</option>
                        </select>
