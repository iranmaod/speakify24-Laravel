...
<div class="page-content">
    <div class="panel">
        <div class="panel-body">
            <form method="POST" action="{{ route('admin.subscription.update') }}" id="reviewForm">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" name="per_month" placeholder="Hours Per Month" value="{{ old('per_month') }}" />
                    ...
                    <!-- <div class="form-group col-md-4">
                        ...
                        <input type="datetime" class="form-control datetime" name="expiry" 
                            placeholder="Expiry" value="{{ old('expiry') }}" />
