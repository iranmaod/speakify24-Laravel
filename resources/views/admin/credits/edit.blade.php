...
<div class="page-header">
    ...
    <h1 class="page-title">Edit Credits</h1>
</div>
...
<div class="page-content">
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('admin.credits.update',$credits->id) }}" id="appintmentForm">
                {{ csrf_field() }}
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select required class="form-control" name="user_id" id="user_id" >
                            ...
                            @foreach($students as $student)
                                <option value="{{ $student->id }}" {{ $credits->user_id == $student->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input required type="number" class="form-control" name="hours" placeholder="No. of hours" value="{{ $credits->total_hours }}" />
                            @if ($errors->has('hours'))
                    ...
                    <div class="form-group col-md-4">
                        <label class="form-control-label">Remaining Hours <span class="required">*</span></label>
                        <input required type="number" class="form-control" name="re_hours" placeholder="No. of hours" value="{{ $credits->hours }}" />
                            @if ($errors->has('hours'))
                                <label class="error" for="title">{{ $errors->first('re_hours') }}</label>
                            @endif
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select required class="form-control" name="lang_id" id="lang_id">
                            ...
                            @foreach($languages as $lang)
                                <option value="{{ $lang->id }}" {{ $credits->lang_id == $lang->id ? 'selected' : '' }}>
                                    {{ $lang->course_title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        placeholder="Appointment Start Time" value="{{ $credits->start_time }}" />
                    ...
                    <div class="form-group col-md-4">
                        ...
                        placeholder="Appointment End Time" value="{{ $credits->end_time }}" />      
                    </div>

                    <div class="form-group col-md-4">
                        <label class="form-control-label">Max. Number of cancellable credits<span class="required">*</span></label>
                        <input required type="number" class="form-control" name="max_credits" placeholder="No. of hours" value="{{ $credits->canc_credits }}" />
                            @if ($errors->has('title'))
                                <label class="error" for="title">{{ $errors->first('title') }}</label>
                            @endif
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" class="form-control" name="weekly_hours" placeholder="No. of hours" value="{{ $credits->weekly_hours }}" />
                            @if ($errors->has('title'))
                                <label class="error" for="title">{{ $errors->first('title') }}</label>
                            @endif
                    </div>
