                    ...
                    <div class="instructor-clist m-0">
                        ...
                        <?php foreach($insturctors as $ins) { ?>
                            <div class="col-md-12 p-2 m-0">
                                ...
                                <b class="col-md-3 p-2">{!! $ins->display_name !!}</b>
                                <a href="{{ route('choose.plan', ['course_id' => $course->id, 'instructor_id' => $ins->user_id]) }}" class="btn btn-sm login-page-button"><span>BOOK NOW</span></a>
                            </div>
                        <?php } ?>
                    </div>
