...
?>
    ...
    <div class="container-fluid p-0 home-content">
        ...
        <div class="subpage-slide-blue bgcoverimg courselist-bg">
            <div class="container">
                <h1>Course List</h1>
            </div>
        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            ...
                            <a href="{{ route('course.view', $course->course_slug) }}" class="c-view">
                                <main>
                                    ...
                                    <?php $insturctors = \App\Models\Course::find($course->id)->getInstructorRecords(); //echo'<pre>';print_r($insturctors);exit;?>

                                    <div class="instructor-clist">
                                        <div class="col-md-12">
                                            <i class="fa fa-chalkboard-teacher"></i>&nbsp;
                                            <span>Assigned to <b>
                                                <?php foreach($insturctors as $k => $ins) {
                                                    if ($k > 3) {
                                                        break;
                                                    }
                                                    if ($k == '3') {
                                                        echo ', ' . $ins->display_name . '.. View More';
                                                    } else if ($k != '0') {
                                                        echo ', ' . $ins->display_name;
                                                    } else {
                                                        echo $ins->display_name;
                                                    }
                                                } ?>
