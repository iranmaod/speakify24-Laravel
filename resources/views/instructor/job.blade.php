                      ...
                      <div class="">
                        <div class="su_course_section_label su_gray_curr_block" style="background-color: #4a98ff;">
                          <div class="col col-lg-6 edit_option edit_option_section">{!! Lang::get('instructor.position')!!} <span class="serialno">{!! $sectioncount !!}</span>: <label class="slqtitle pos{!! $job->id !!}">{!! $job->position !!}</label>
						   ...
						   <div class="col col-lg-6 edit_option edit_option_section job_description">{!! Lang::get('instructor.description')!!} <span class="serialno">{!! $sectioncount !!}</span>: <label class="slqtitle des{!! $job->id !!}" style="max-width:75%;text-align:left;">{!! $job->description !!}</label>                            
