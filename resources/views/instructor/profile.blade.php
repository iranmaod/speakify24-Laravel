    ...
    <form method="POST" action="{{ route('instructor.profile.save') }}" id="profileForm" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="contact_email"  readonly="readonly"
		...
		<div class="form-group col-md-4">
            <label class="form-control-label">Youtube Intro Link </label>
            <input type="text" class="form-control" name="youtube_link" 
                placeholder="Youtube Intro Link" value="{{ $instructor->youtube_link }}" />
                @if ($errors->has('youtube_link'))
                    <label class="error" for="youtube_link">{{ $errors->first('youtube_link') }}</label>
                @endif
        </div>
		<!--<div class="form-group col-md-4">
		...
		<div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="city" 
                placeholder="City" value="{{ $instructor->city }}" />
                @if ($errors->has('city'))
		...
		<div class="form-group col-md-4">
            ...
            <select class="form-control" name="country_id">
				...
				@foreach($countries as $country)
                    ...
                    @if($country->id == $instructor->country_id){{ 'selected' }}@endif>
                        {{ $country->name }}
                    </option>
                @endforeach				
            </select>
		...
		<div class="form-group col-md-4">
           ...
           <div>
			  <div class="radio-custom radio-default radio-inline">
				<input type="radio" id="inputBasicActive" name="is_native" value="1" @if($instructor->is_native) checked @endif />
				<label for="inputBasicActive">Yes</label>
			  </div>
			  <div class="radio-custom radio-default radio-inline">
				<input type="radio" id="inputBasicInactive" name="is_native" value="0" @if(!$instructor->is_native) checked @endif/>
		...
		<!-- <div class="form-group col-md-4">
            <label class="form-control-label">Instant Booking </label>
             <div>
			  <div class="radio-custom radio-default radio-inline">
				<input type="radio" id="inputBasicActive" name="is_instant_booking" value="1" @if($instructor->is_instant_booking) checked @endif />
				<label for="inputBasicActive">Yes</label>
			  </div>
			  <div class="radio-custom radio-default radio-inline">
				<input type="radio" id="inputBasicInactive" name="is_instant_booking" value="0" @if(!$instructor->is_instant_booking) checked @endif/>
				<label for="inputBasicInactive">No</label>
			  </div>
			</div>
        </div> -->
		<div class="form-group col-md-4">
           ...
           <select class="form-control" name="language_speak_id">
				...
				@foreach($languages as $language)
                    ...
                    @if($language->id == $instructor->language_speak_id){{ 'selected' }}@endif>
                        {{ $language->title }}
                    </option>
                @endforeach					
            </select>
		...
		<div class="form-group col-md-4">
            ...
            <select class="form-control" name="language_teach_id">
				...
				@foreach($languages as $language)
                    <option value="{{ $language->id }}"
                    @if($language->id == $instructor->language_teach_id){{ 'selected' }}@endif>
                        {{ $language->title }}
                    </option>
                @endforeach				
            </select>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="tax_number" 
                placeholder="Tax Number" value="{{ $instructor->tax_number }}" />
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
	            ...
	            <textarea name="who" class="form-control">
	                {!! $instructor->who !!}
	            </textarea>
                @if ($errors->has('who'))
            ...
            <div class="form-group col-md-4">
	            ...
	            <textarea name="love_job" class="form-control">
	                {!! $instructor->love_job !!}
	            </textarea>
